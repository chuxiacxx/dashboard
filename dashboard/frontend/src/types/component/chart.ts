...
export interface BarDataItem {
  ...
  yAxisIndex?: number  // 添加 yAxisIndex 属性
}
...
export interface MixedChartProps extends BaseChartProps {
  ...
  // Y轴配置
  yAxisType?: 'single' | 'dual'
  yAxisName?: [string, string]
  yAxisPosition?: ['left' | 'right', 'left' | 'right']
  
  // 交互配置
  showDataZoom?: boolean
  tooltipFormatter?: any
  
  // ⭐ 必须显式声明从 BaseChartProps 继承的属性
  showLegend?: boolean
