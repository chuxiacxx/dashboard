  ...
  <div class="space-y-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div class="art-card p-5 flex flex-col">
        <h3 class="text-base font-medium mb-4">销售转化情况</h3>
...
const getMonthLastDay = (month: string): string => {
  ...
  const date = new Date(year, m, 0) // m=0 means last day of previous month
...
const loadData = async () => {
  try {
    ...
    const salesRes: any = await fetchSalesList(params)
