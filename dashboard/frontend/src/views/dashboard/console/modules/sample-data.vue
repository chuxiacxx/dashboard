  ...
  <div class="art-card p-4 flex flex-col" style="height: 36rem;">
    ...
    <div class="mt-4 overflow-y-auto" style="flex: 1; min-height: 0;">
      ...
      <el-table :data="monthlySummary" size="small" border style="width: 100%">
        ...
        <el-table-column prop="sampleCount" label="送样" align="center">
          <template #default="{ row }">
            <span class="font-medium text-blue-500">{{ row.sampleCount }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="orderCount" label="订单" align="center">
          <template #default="{ row }">
            <span class="font-medium text-green-500">{{ row.orderCount }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="modelCount" label="型号" align="center">
          <template #default="{ row }">
            <span class="font-medium text-purple-500">{{ row.modelCount }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="customerCount" label="客户" align="center">
          <template #default="{ row }">
            <span class="font-medium text-orange-500">{{ row.customerCount }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="deliveryRate" label="交货率" align="center">
          <template #default="{ row }">
